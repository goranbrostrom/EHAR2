...
\end{figure}
-->
The data at hand looks like Table \@ref(tab:datah11).
```{r datah11, echo = FALSE}
source("R/tbl.R")
load("zz.RData")
tbl(head(zz[, -(2:3)], 5), caption = "Emigration and mortality data, Skellefteå 1800-1870.")
```
...
```{r withcox11, comment = "", results = 'asis'}
