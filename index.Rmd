...
The first edition of this book was published 1i 2012, nine years ago. Since then
the field has grown and developed rapidly, both in terms of available scientific data and
...
chapters have been reordered so that the logical flow is clearer.

*[some more to be added here...]*

The writing of this book has been done in parallel with the development of the **R** package
`eha` [@eha]. All the data sets used in the examples in this book are available in `eha`, 
so you can easily play around with them on your own.
