...
I have switched to **knitr** and **bookdown** (with some support by **LaTeX**). So there has been, and still is,  a 
lot of work with translation (much more than I anticipated) from the former to the latter. For the moment 
(March 1, 2020), Chapters 1--6  are translated (but not finished).
