...
url: 'http\://goranbrostrom.se/EHAR2/'
...
This is the place for the *Preface to the Second Edition*, which is not written yet. 
Instead, for the time being, I will try to keep you and myself updated about the 
ongoing work with the second edition. You will find the *Preface to the First Edition*
two pages ahead.

*The First Edition* was written with the aid of  *Sweave* and $\text{\LaTeX}$, but for the second edition 
I have switched to *knitr* and *bookdown*. So now in the beginning, there will be a 
lot of work with translation (much more than I anticipated) from the former to the latter. For the moment (mid 
January 2018), Chapters 1 and 2 are translated (but not finished), and I
am currently working on translating *Chapter 3*.
...
history analysis on the market,
 \cite{abg08}, \cite{abgk93},
\cite{coxoakes84}, \cite{ph00},
\cite{kp02}, and \cite{jl03} to mention a few. Some of these are already
classical, but they all are aimed at an audience with solid mathematical
and statistical background. On the other hand, the  \cite{pm95},
\cite{pa84}, \cite{pasas95},
\cite{km03},
\cite{collett}, and
\cite{ejj99} books are all more basic but lack the special treatment
...
absolutely first was \emph{The Demographic Data Base} (DDB) at Umeå
...
development, with the handling of large data sets in mind, of $\sc Fortran$
...
The time period covered by the DDB data is approximately the $19^{th}$
...
are \emph{open source}, and one of the survival analysis packages [@eha]
...
sources. Consult the home of R,

\url{http://www.r-project.org}
and search under \emph{Documentation}. Appendix C also contains a separate
section
...
latest version of R from [CRAN](http://cran.r-project.org) and
