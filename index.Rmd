...
I have switched to **knitr** and **bookdown** (with some support by **LaTeX**). So now in the beginning, there will be a 
lot of work with translation (much more than I anticipated) from the former to the latter. For the moment (mid 
Febuary 2020), Chapters 1--5  are translated (but not finished), and I
am currently working on translating *Chapter 6*.
