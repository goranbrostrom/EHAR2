...
I have switched to **knitr** and **bookdown** (with some support of **LaTeX**). So there has been, and still is,  a 
lot of work with translation (much more than I anticipated) from the former to the latter. For the moment 
(August 17, 2020), all Chapters are translated (but not polished), and the Appendices remain.
Adding new material and updating the old is now beginning.  I have just discovered the 
[R markdown cookbok](https://bookdown.org/yihui/rmarkdown-cookbook/), which I hope will 
make my tedious cleaning-up-after-latex work easier.
