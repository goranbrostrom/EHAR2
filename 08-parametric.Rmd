...
Tn the *proportional hazards* case, the *rate* formulation is used, and it is
...
out <- round(out, 4)
knitr::kable(out, booktabs = TRUE, caption = "Coefficients with Gompertz, Cox and Weibull regressions, data oldmort.")
```
...
previous Weibull and Cox regression analyses with the original time scale.
