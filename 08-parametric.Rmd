...
The data set **oldmort** in the **R** package **eha** contains
  ...
  in Skellefteå. The data set is described in detail in Chapter 1. See 
  Table \@ref(tab:olddata8), where the most important variables are shown.
  Note that the number 60 has been subtracted from the original values, so that 
  they measure time since age 60 instead of age. The reason for this will be explained 
  soon.
...
in years since the sixtieth birthday, *age* is age at start of follow-up, and *ses.50*
