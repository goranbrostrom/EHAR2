...
Today the function `coxreg`\index{Functions!coxreg} 
in `eha`
...
`coxreg`.\index{Functions!coxreg} It is activated by setting the
...
*   **Parametric proportional hazards models** The common parametric models
  ...
  `eha` for these models (`aftreg`\index{Functions!aftreg}),
  the function `phreg`\index{Functions!phreg} fits 
...
*   **Lexis diagram cuts** With the aid of the two functions
  `age.window`\index{Functions!age.window} and `cal.window` 
\index{Functions!cal.window}    
...
*   **coxph**\index{Functions!coxph|(} 
  ...
  algorithms.\index{Functions!coxph|)}  
