...
mortality conditions of the year 2019. Of course no real individual can
...
```{r famdens192, ech = FALSE, fig.cap = "Density function for Swedish women 2019.", ech0 = FALSE}
par(las = 1)
...
\begin{equation*}
S(t) = \sum_{i: r_i \ge x} p_i, \quad -\infty < t < \infty,
\end{equation*}
...
*Nelson-Aalen* estimator  [@nel72; @aa78] of the cumulative hazards function, see the next
...
```{r pshazsur,fig=TRUE,echo=FALSE,fig.cap="Nelson-Aalen plot (left panel) and Kaplan-Meier plot (right panel), male mortality data. The dashed lines in the Survival function plot are pointwise 95 percent confidence limits.", scap = "Male mortality, Nelson-Aalen and Kaplan-Meier plots.", fig.height = 3}
library(eha)
...
data frame `mort`. The function `Surv`\index{Functions!`Surv`}, imported
