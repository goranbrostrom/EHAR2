...
```{r lifetablefig, fig.cap = "Life table and survival function, females, Sweden 2016.", fig.scap = "Life table and survival function, females, Sweden 2016.", echo = FALSE}
library(eha)
...
```{r densityfig, fig.cap = "Interpretation of the density function.", echo=FALSE}
x <- seq(0, 2, length = 100)
plot(x, dweibull(x, scale = 1, shape = 2), type = "l", axes = FALSE)
axis(1)
axis(2)
```