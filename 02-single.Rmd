...
For the Swedish women 2019, the estimated density function is shown in Figure \@ref(fig:famdens192).

```{r famdens192, ech = FALSE, fig.cap = "Density function for Swedish women 2019."}
par(las = 1)
...
For the Swedish women 2019, the estimated hazard function (age-specific mortality) is shown in Figure \@ref(fig:famhaz192).

```{r famhaz192, ech = FALSE, fig.cap = "Hazard function for Swedish women 2019.", echo = FALSE}
par(las = 1)
...
For the Swedish women 2019, the estimated cumulative hazard function is shown in Figure \@ref(fig:famcumhaz192).

```{r famcumhaz192, ech = FALSE, fig.cap = "Cumulative hazard function for Swedish women 2019.", echo = FALSE}
par(las = 1)
