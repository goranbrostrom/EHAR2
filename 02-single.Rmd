...
```{r pshazsur,fig=TRUE,echo=FALSE,fig.cap="Nelson-Aalen plot (left panel) and Kaplan-Meier plot (right panel), male mortality data. The dashed lines in the Survival function plot are pointwise 95 percent confidence limits.", fig.scap = "Male mortality, Nelson-Aalen and Kaplan-Meier plots.", fig.height = 3}
library(eha)
