...
the life table. It depicts the actual size of a hypthetical birth cohort\index{cohort},
_year by year_,
...
```{r lifetablefig, fig.cap = "Life table and survival function, females, Sweden 2020.", fig.scap = "Life table and survival function, females, Sweden 2019.", echo = FALSE,fig.height=4,message=FALSE}
library(eha)
