...
tbl(head(atmp, 3), fs = 10, 
    caption = "Average daily max temperature by month, Umeå 1901-50.")
```
...
tbl(head(nt[, -8], 3), fs = 10, 
    caption = "Population data by year and month, Umeå 1901-50.")
```
...
fit.out(fit, label = "coxph7", 
        caption = "Mortality and temperature, Umeå 1901-50.")
```
