...
mortality is lowered in all age groups from one year to the next, but this is different.
...
in the **eha** package for a smooth and simple way of analysing tabular data.
