...
```
\label{ex:sw07}
We create a data set `swe07` (a subset and combination of `swepop` 
...
```{r swe07}
swe07 <- swepop[swepop$year == 2007, ]
swe07$deaths <- swedeaths$deaths[swedeaths$year == 2007]
swe07 <- swe07[swe07$age >= 61 & swe07$age <= 80, c("age", "sex", "deaths", "pop")]
pout <- rbind(head(swe07, 5), c("...", "...", "...", "..."), tail(swe07, 5))
knitr::kable(pout, booktabs = TRUE, row.names = FALSE, label = "swe076180",
             caption = "Swedish population data 2007, ages 61-80.")
...
```{r rawcal}
femal <- swe07[swe07$sex == "women", ]
mal <- swe07[swe07$sex == "men", ]
