...
One version of the corresponding survival function is shown in Figure \@ref(figkmout6).
```{r kmout6,fig.height = 5,fig.cap="Survival plot with the aid of the function risksets.",fig.scap="Survival plot with the aid of the function risksets"}
par(las = 1)
