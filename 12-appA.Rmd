...
tt <- data.frame(Group = c("I", "II", "Total"), 
                 ...
                 Total = c("n1", "n2", "n"))
tbl(tt, caption = "General table in a log rank test.")
```
...
the package **eha**), with selected variables, is used. A summary of the data is shown
...
##summary(ume)
tbl(head(umetab, 5), caption = "Data about adult mortality in Umeå, first half of 20th ccentury.")
```
