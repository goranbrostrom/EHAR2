...
```{r oldmortf7} 
cap = "The old age mortality data."
tbl(tail(oldmort[, 2:9], 5), caption = cap)
``` 
...
`r round(fit0$loglik[2], 1)` compared to 
`r round(fit$loglik[2], 1)`! The conclusion is that in this case, there
...
See the example about maternal end infant mortality in Chapter 10.
