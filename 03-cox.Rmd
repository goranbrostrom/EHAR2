...
advantage is equally large in all ages. See Example \@ref(exm:sw19) for a
...
But *how large* is the difference? The answer is found at `exp(coef) = 0.8135`, which tells us that the female risk of dying is about 81 per cent of the male risk, *at each age between 60 and 85*.
