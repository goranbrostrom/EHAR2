...
```{example, name = "Marital fertility in 19th century Sweden", label = "marfert"}
...
Another useful setup is the _illness-death_ model, see
...
_Dead_, which is an _absorbing state_\index{absorbing state},
