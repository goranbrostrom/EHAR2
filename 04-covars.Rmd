...
The sampling frame is a rectangle in the Lexis diagram, see Figure \@ref(fig:lexmortfour). It can be described as all persons born between January 1, 1775 and January 1, 1881, and present in the solid rectangle at some moment.

```{r lexmortfour, fig.cap = "Old age mortality sampling frame, Lexis diagram.", echo = FALSE, fig.height = 4}
...
irectly to the estimated coefficients after adding an interaction term to the model:
...
terms must be there. (There are some exceptions to this rule.)
